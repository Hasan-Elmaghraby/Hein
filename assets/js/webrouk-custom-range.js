...
webroukCustomRangeTemplate.innerHTML = `
  <style>
    :host {
      ...
      --w-iniVal-display: block;
      --w-handle-line-height: 6px;
    ...
    .webroukRange__line {
      position: relative;
      height: var(--w-handle-line-height, 5px);
    ...
    .webroukRange__iniVal {
      top: 0;
      display: var(--w-iniVal-display, block);
    }
    ...
    .webroukRange__handle {
      position: absolute;
      top: calc((var(--w-handle-size) - (var(--w-handle-size) / 4)) / -1.4);
      -webkit-transform: translateX(-50%);
      -ms-transform: translateX(-50%);
      transform: translateX(-50%);
      height: var(--w-handle-height, var(--w-handle-size));
      width: var(--w-handle-width, var(--w-handle-size));
      background-color: var(--w-primary-color, var(--w-primary-color-fb));
      border: calc(var(--w-handle-size) / 6) solid var(--w-primary-color, var(--w-primary-color-fb));
      border-radius: var(--w-radius-size , 50%);
    ...
    .webroukRange__handle__curVal {
      top: calc((var(--w-handle-size) * -3) + ((var(--w-handle-size) / 6) * 2));
      left: 50%;
      background-color: transparent;
      color: var(--w-primary-color);
      font-size: var(--w-handle-label-font-size, 0.875rem);
    }
    ...
    .webroukRange__singleVal {
      top: calc((var(--w-handle-size) * -3.5) + (var(--w-handle-size) / 8));
      left: 50%;
      white-space: nowrap;
    }
